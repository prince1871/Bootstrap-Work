        ...
        flex justify-between flex-col sm:flex-row">
          <h1 className="text-3xl font-bold
           ...
           mb-2 md:mb-0">
            ...
            n0-underline hover:text">Emmyboi</Link>
            </h1>
            <div className="flex flex-row justify-center sm:justify-evenly align-middle 
            gap-4 text-white text-4xl lg:text-5xl">
              <Link className="text-white/90 hover:text-white" href="https://www.youtube.com/@DaveGrayTechesCode">
                <FaYoutube />
              </Link>
              ...
              <Link className="text-white/90 hover:text-white" href="https://twiter.com/yesdavidgray">
                <FaTwitter />
              </Link>
            </div>
        </div>
